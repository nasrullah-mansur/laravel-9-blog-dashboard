...
function autoPosition() {
    Array.from($(".dd li.dd-item")).forEach(function (value, index) {
...
function getItemValueOnKeyUp() {
    $(".dd-list, .dd-custom").on("keyup", 'input[name="label"]', function () {
    ...
    $(".dd-list, .dd-custom").on("keyup", 'input[name="class"]', function () {
        let inputVal = $(this).val();
        let getLi = $(this).parents("li").first();
        getLi.attr("data-class", inputVal);
    });

    $(".dd-list, .dd-custom").on("keyup", 'input[name="slug"]', function () {
        let inputVal = $(this).val();
        let getLi = $(this).parents("li").first();
        getLi.attr("data-slug", inputVal);
    });

    $(".dd-list, .dd-custom").on(
        "change",
        'select[name="target"]',
        function () {
            let inputVal = $(this).val();
