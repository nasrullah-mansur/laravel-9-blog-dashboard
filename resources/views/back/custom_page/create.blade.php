@extends('back.layout.layout', [$title = 'Create a new custom page']);
...
<div class="col-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title" id="basic-layout-square-controls">Create a new custom page</h4>
          ...
          <form class="form" action="{{ route('custom.page.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="title" class="form-control square {{ $errors->has('title') ? 'is-invalid' : ''}} " placeholder="Title" name="title">
                @if ($errors->has('title'))
              ...
              <fieldset class="form-group mb-0">
                ...
                <textarea id="html" rows="5" class="form-control summernote" name="html" placeholder="HTML"></textarea>
                @if($errors->has('html'))
              ...
              <fieldset class="form-group">
                ...
                <textarea id="css" rows="5" class="form-control" name="css" placeholder="CSS"></textarea>
                @if($errors->has('css'))
              ...
              <fieldset class="form-group">
                ...
                <textarea id="javascript" rows="5" class="form-control" name="javascript" placeholder="Custom JavaScript"></textarea>
