                ...
                <table class="table table-bordered mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        @foreach ($chamber->days as $d)
                          <p style="margin: 2px;" class="btn btn-primary btn-sm">{{ $d->day }}</p>
                        @endforeach
                      </td>
                      <td>
                        @foreach ($chamber->times as $t)
                          <p style="margin: 2px;" class="btn btn-primary btn-sm">{{ $t->time }}</p>
                        @endforeach
                      </td>
                      <td>{{$chamber->time }}</td>
                      <td>{{$chamber->appoint_limit }}</td>
