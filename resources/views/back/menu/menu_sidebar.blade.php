...
$(".add-item-to-menu").on("click", function () {
    ...
    Array.from(getLiSelect).forEach(function (item) {
        let setData = {
            ...
            liClass: item.getAttribute("data-class")
                ? item.getAttribute("data-class")
                : null,
            liPosition: item.getAttribute("data-position")
                ? item.getAttribute("data-position")
                : null,
            liTarget: item.getAttribute("data-target")
                ? item.getAttribute("data-target")
                : null,
        };

        console.log("{{ route('menuItem.addItem') }}");
